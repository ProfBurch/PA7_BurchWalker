...
{ return studentData.absences; }

int Node::getRecordNumber() const 
{ return studentData.recordNumber; }

int Node::getID() const 
{ return studentData.IDNumber; }

int Node::getUnits() const 
{ return studentData.units; }
...
string Node::getRecentAbsence() 
{ return studentData.dateOfAbsences.peek(); }

Stack Node::getAbsencesList() const 
{ return studentData.dateOfAbsences; }

/**SETTERS**/
void Node::setAbsences(int newData) 
{ studentData.absences = newData; }

void Node::setRecordNumber(int newData) 
{ studentData.recordNumber = newData; }

void Node::setID(int newData) 
{ studentData.IDNumber = newData; }

void Node::setUnits(int newData) 
{ studentData.units = newData; }

void Node::setName(string newData) 
{ studentData.name = newData; }

void Node::setEmail(string newData) 
{ studentData.email = newData; }

void Node::setMajor(string newData) 
{ studentData.major = newData; }

void Node::setLevel(string newData) 
{ studentData.level = newData; }

void Node::setNext(Node* const newData) 
{ pNext = newData; }

void Node::setAbsencesStack(Stack newData) 
{ studentData.dateOfAbsences = newData; }
